                      ...
                      <h3 class="mb-4">Login</h3>
                        <form action="">
                            <div class="form-outline mb-4">
                                <input type="email" id="typeEmailX-2" class="form-control form-control-lg" placeholder="E-mail" required />
                              </div>

                              <div class="form-outline mb-4">
                                <input type="password" id="typePasswordX-2" class="form-control form-control-lg" placeholder="Password" required />
                              </div>
                              <button style="width: 50%;" class="btn btn-primary btn btn-block" type="submit">Login</button>
                        </form>
